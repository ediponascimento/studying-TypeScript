...
function () {
  ...
  View.prototype.mapRigions = function (fragment) {
  ...
  View.prototype.render = function () {
    ...
    this.mapRigions(templateElement.content);
    this.onRender();
...
},{"../views/View":"src/views/View.ts"}],"src/views/UserShow.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Eventing() {
    ...
    this.trigger = function (eventName) {
      ...
      handlers.forEach(function (calback) {
        return calback();
      });
    };
  }
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (value) {
        var user = _this.deserialize(value);
...
},{"axios":"node_modules/axios/index.js","../models/Eventing":"src/models/Eventing.ts"}],"src/models/User.ts":[function(require,module,exports) {
"use strict";
...
exports.User = User;
},{"../models/Model":"src/models/Model.ts","../models/Attributes":"src/models/Attributes.ts","../models/ApiSync":"src/models/ApiSync.ts","../models/Eventing":"src/models/Eventing.ts","../models/Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
},{"../src/views/UserEdit":"src/views/UserEdit.ts","./models/User":"src/models/User.ts"}],"../../../../../usr/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../usr/lib/node_modules/parcel/src/builtins/hmr-runtime.js","src/index.ts"], null)
